...
class GraduateSchoolEssayRedraftService
{
    ...
    {
        $package = $this->graduate_school_essay_redraft_repository->decline_assign($assign_data);
        $user_cont = new UserController();
    ...
    {
        $package = $this->graduate_school_essay_redraft_repository->approve_assign($assign_data);
        $user_cont = new UserController();
    ...
    {
        $package = $this->graduate_school_essay_redraft_repository->assign_associate($assign_data);
        $user_cont = new UserController();
        $associate = $user_cont->getUserById($assign_data["associate_id"]);
        $user = $user_cont->getUserById($package->user_id);
