...
<div class="message-body">
    ...
    Hello, {{$associate->first_name. " ". $associate->last_name}}
    <div class="message-body-inner">

        <p >Gradsuccess is pleased to Notify you that your request to assign yourself an application has been approved.</p>
        <br>
